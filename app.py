  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "PnWXCFSGyTVS",
        "outputId": "bb0cd80d-3d41-4e95-b475-d2d2be5d7389"
      },
      "execution_count": 14,
      "outputs": [
        {
          ...
          "text": [
            ...
            "2026-01-22 08:24:31.015 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2026-01-22 08:24:31.016 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2026-01-22 08:24:31.016 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2026-01-22 08:24:31.017 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2026-01-22 08:24:31.019 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2026-01-22 08:24:31.019 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n"
          ]
        }
      ]
